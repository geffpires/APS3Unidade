...
class EscalonadorPrioridadeTest {
	...
	public void comcorrenciaSoComMaisDe1Prcesso() {
		...
		assertEquals(ep.getStatus(),("Status: 1 - P1 (Executando)\nP2 (Esperando)\n"
				...
				+ "    Tick: 4\n"
				+ "    Quantium: 3"));
		assertEquals(ep.getEscalonadores().get(0).getExecutando().getQantTickNoEscalonador(),1); //O getQantTickNoEscalonador diz a quantos tick o processo est· com concorrencia
	}
	@Test//T21
	...
	@Test//Hiper Teste Merda Grand„o Final
	...
	public void intercalaProcessoNaMesmaPrioridade1() {
		...
		assertEquals(ep.getStatus(),("Status: 1 - P1 (Executando)\n"
				...
				+ "    Quantium: 3"));
		ep.avancarTick();
		assertEquals(ep.getEscalonadores().get(0).getExecutando().getQantTickNoEscalonador(),1);
		ep.avancarTick();
		assertEquals(ep.getEscalonadores().get(0).getExecutando().getQantTickNoEscalonador(),2);
		ep.avancarTick();
		assertEquals(ep.getEscalonadores().get(0).getExecutando().getQantTickNoEscalonador(),3);
		ep.avancarTick();
		assertEquals(ep.getStatus(),("Status: 1 - P2 (Executando)\n"
